...
**Status**: First Draft
**Style Card**: First-person, casual, BLUF openers, "But" transitions, named tools/features, no weasel words
...
It's currently trending in the top 10 on the Chrome Web Store, with over 100,000 users. But more importantly, it's replaced almost every other SEO extension I used to rely on.
...
**Pro tip:** Extensions are great for spot-checking individual pages. When you need to audit an entire site—thousands of pages at once—use [Ahrefs' Site Audit](https://ahrefs.com/site-audit) instead. It crawls up to 5,000 pages for free (with Ahrefs Webmaster Tools) and checks 170+ technical SEO issues, prioritizing what to fix first.
...
Hunter has a free tier (25 searches/month), with paid plans for heavier usage.
...
**Fact-check:**
- "100,000+ users" for Ahrefs SEO Toolbar - verify current number
- "trending top 10 on Chrome Web Store" - verify if still accurate
- Hunter free tier limits (25 searches/month) - verify current
